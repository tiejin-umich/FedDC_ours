...
# Dirichlet (0.3)
data_obj = DatasetObject(dataset='TinyImageNet', n_client=n_client, seed=0, unbalanced_sgm=0, rule='Drichlet', rule_arg=0.01, data_path=data_path)

model_name = 'ConvNet_TinyImageNet' # Model type
